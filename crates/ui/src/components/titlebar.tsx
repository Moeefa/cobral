            ...
            <div className="flex w-full items-center justify-between gap-2">
              ...
              <div className="flex gap-1 p-0.5 items-center bg-background rounded-sm">
                <Button
                  ...
                  variant="ghost"
                  onClick={() =>
                    setFontSize((prev) => +parseFloat((prev - 0.01).toFixed(2)))
                  }
                >
                  -
                </Button>
            ...
            <DropdownMenuPortal>
              <DropdownMenuSubContent>
                <DropdownMenuRadioGroup value={theme} onValueChange={setTheme}>
                  <DropdownMenuRadioItem value="quietlight">
                    Quietlight
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem value="github-light">
                    Github Light
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem value="vscode-light">
                    Visual Studio Code Light
                  </DropdownMenuRadioItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuRadioItem value="okaidia">
                    Okaidia
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem value="github-dark">
                    Github Dark
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem value="vscode-dark">
